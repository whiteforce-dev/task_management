...
class TeamAllotedController extends Controller
{
    ...
    public function needApproval()
    {
        ...
        if (!empty($is_tl) || Auth::user()->type == 'manager' || Auth::user()->type == 'admin') {
            ...
            $tasklist = Taskmaster::whereIn('is_approved', [0])->where('software_catagory', Auth::user()->software_catagory)->where('alloted_to', Auth::user()->id)->OrderBy('id', 'DESC')->paginate('25');
        }
