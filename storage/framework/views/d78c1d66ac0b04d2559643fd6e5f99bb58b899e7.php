        ...
        <div class="container-fluid py-2">
            <div class="alert alert-secondary mx-1" role="alert">
                <span class="text-white">
                    ...
                    <a href="<?php echo e(url('user-profile')); ?>" class="btn bg-gradient-primary btn-sm mb-0" type="button"
                            ...
                            <tbody>
                                <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><img src="<?php echo e(url($user->image ?? 'NA')); ?>" class="avatar avatar-sm me-3"></td>
                                        <td><?php echo e(ucfirst($user->name)); ?></td>
                                        <td><?php echo e($user->email); ?></td>
                                        <?php
                                        $managerName = \App\Models\User::where('id', $user->parent_id)->value('name');
                                        ?>
                                        <td><?php echo e(ucfirst($managerName ?? 'Null')); ?></td>
                                        <td><?php echo e(ucfirst($user->type)); ?></td>
                                        
                                        <?php if(Auth::user()->type !== 'employee'): ?>
                                        <td class="text-center">
                                            <a href="<?php echo e(url('edituser', $user->id)); ?>" class="mx-3">
                                                <i class="fas fa-user-edit text-primary"></i>
                                            </a>
                                            <span>
                                                <a href="<?php echo e(url('delete-user', $user->id)); ?>" class="mx-3">
...
<?php echo $__env->make('layouts.user_type.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\task_management\resources\views/laravel-examples/userlist.blade.php ENDPATH**/ ?>