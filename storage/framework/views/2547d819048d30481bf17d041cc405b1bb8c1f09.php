        ...
        <div class="container-fluid py-2">
            <div class="alert alert-secondary mx-1" role="alert">
                <span class="text-white">
                    ...
                    <a href="<?php echo e(url('account-create')); ?>" class="btn bg-gradient-primary btn-sm mb-0" type="button"
                ...
                <div class="col-12">
                    <div class="card">
                        <table class="table datatable">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $accountlist; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $account): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <th scope="row"><?php echo e(++$i); ?></th>
                                        <td><?php echo e(ucfirst($account->name)); ?></td>                                                                           
                                        <td><a href="<?php echo e(url('account-editpage', $account->id)); ?>">Edit</a></td>                                                                           
                                        <td><a href="<?php echo e(url('delete-account', $account->id)); ?>">Delete</a></td>                                                                           
                                    </tr>
...
<?php echo $__env->make('layouts.user_type.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\task_management\resources\views/account/accountlist.blade.php ENDPATH**/ ?>