    ...
    <div class="row col-md-12" style="padding-left: 11px;padding-bottom: 9px;">
        <div class="col-md-1">
            <div class="summryproimg">
                <img src="<?php echo e(!empty($alloted_summary_array[$allotted]['user_image']) ? url($alloted_summary_array[$allotted]['user_image']) : ''); ?>" alt="" width="100%">
            </div>
        </div>
    ...
    <div class="main-card"> 
        <div class="long-width" style="width: 70%;">
            <div class="up-box">
                ...
                <span class="badge badge-primary" style="background: linear-gradient(to right, #f953c6, #b91d73); margin-right:10px; width:100px; width: 65px;height: 30px;"><?php echo e($task->task_code); ?></span>
            ...
            <div class="low-box remarkbox">
                ...
                <div class="comments">
                    ...
                    <div class="comment-one">
                        <div class="proimg">
                            <img src="<?php echo e(!empty($remark->GetUser->image) ? url($remark->GetUser->image) : ''); ?>" alt="" width="100%">
                        </div>
                ...
                <div class="view-btn">
                    <a href="javascript:" onclick="managerRemark('<?php echo e(url('managerremark' . '?id=' . $task->id)); ?>')" class="dropdown-item border-radius-md lowerbtn" href="javascript:;">View More</a>
                </div>
                <?php endif; ?>
            </div>
        </div>
        <div class="short-width" style="width: 30%;">
            <div class="box-one box-btn">
                <div class="dropdown" style=" margin-right: 10px;">
                    ...
                    <?php else: ?>
                        <?php if(Auth::user()->type != 'employee' || checkIsUserTL(Auth::user()->id) || checkTaskCreatedBy($task->id, Auth::user()->id)): ?>
                            <select class="dropbtn1 status-dropdown" style="background:<?php echo e($dropdownColor); ?> !important" name="selectstatus" data-task-id="<?php echo e($task->id); ?>">
                            ...
                            <option value="<?php echo e($statuss->id); ?>" <?php echo e($statuss->id == $task->status ? 'selected' : ''); ?>><?php echo e(ucfirst($statuss->status)); ?></option>   
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        <?php else: ?>
                            <select class="dropbtn1 status-dropdown" style="background:<?php echo e($dropdownColor); ?> !important"  name="selectstatus" data-task-id="<?php echo e($task->id); ?>">
                ...
                <div class="dropdown btn-card">
                    <a class="dropbtn aaa" href="javascript:void(0)">Action<i style="font-size:0.75rem; margin-left: 5px;" class="fa-solid fa-chevron-down"></i></a>
                        ...
                        <?php endif; ?>
                        <a href="javascript:"
                            onclick="managerRemark('<?php echo e(url('managerremark' . '?id=' . $task->id)); ?>')" class="dropdown-item border-radius-md" href="javascript:;">Remarks</a>
            ...
            <div class="box-one">
                ...
                ?>
                <P><?php echo e(array_sum($spent_hours) + floor($total_spent_mins / 60)); ?>h <?php echo e(($total_spent_mins % 60)); ?>m</P>
            </div>
...
</script><?php /**PATH C:\xampp\htdocs\task_management\resources\views/task/searchTaskResult.blade.php ENDPATH**/ ?>