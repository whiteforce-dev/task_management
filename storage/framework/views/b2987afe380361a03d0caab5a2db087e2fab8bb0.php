            ...
            <div class="card">
                <div class="card-body p-3">
                    <div class="row">
                        <div class="col-8">
                            <div class="numbers">
                                <a href="<?php echo e(url('dashbordtotaltask', Auth::user()->id)); ?>">
                                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Total</p>
                                    <h5 class="font-weight-bolder mb-0">
                                        <?php echo e($totaltask ?? 'Na'); ?>
            ...
            <div class="card">
                <div class="card-body p-3">
                    <div class="row">
                        <div class="col-8">
                            <div class="numbers">
                                <a href="<?php echo e(url('dashbordcompletetask', Auth::user()->id)); ?>">
                                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Completed</p>
                                    <h5 class="font-weight-bolder mb-0">
                                        <?php echo e($complettask ?? 'Na'); ?>
        ...
        <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
            <div class="card">
                <div class="card-body p-3">
                    <div class="row">
                        <div class="col-8">
                            <a href="<?php echo e(url('dashboardpending', Auth::user()->id)); ?>">
                                <p class="text-sm mb-0 text-capitalize font-weight-bold">Pending</p>
                                <h5 class="font-weight-bolder mb-0">
                                    <?php echo e($pendingtask ?? 'Na'); ?>

                                    <span class="text-success text-sm font-weight-bolder">+<?php echo e($per_p ?? '0'); ?>%</span>
                                </h5>
                            </a>
                        </div>
                        <div class="col-4 text-end">
            ...
            <div class="card">
                <div class="card-body p-3">
                    <div class="row">
                        <div class="col-8">
                            <div class="numbers">
                                <a href="<?php echo e(url('dashboardproccess', Auth::user()->id)); ?>">
                                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Progress</p>
                                    <h5 class="font-weight-bolder mb-0">
                                        <?php echo e($proccesstask ?? 'Na'); ?>

                                        <span class="text-success text-sm font-weight-bolder">+<?php echo e($per_PP ?? '0'); ?>%</span>
                                    </h5>
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="d-flex flex-column h-100">
                                <p class="mb-1 pt-2 text-bold">White-force</p>
                                <h5 class="font-weight-bolder">Dashboard</h5>
                                <p class="mb-5">White force makes every one's life easy & every task magical. This task
                                    management solution keeps you updated in all your everyday tasks. Always be updated!!
                                </p>
                        ...
                        <div class="col-lg-5 ms-auto text-center mt-5 mt-lg-0">
                            <div class="bg-gradient-primary border-radius-lg h-100">
                                <img src="<?php echo e(url('assets/img/shapes/waves-white.svg')); ?>"
                                    class="position-absolute h-100 w-50 top-0 d-lg-block d-none" alt="waves">
                                <div class="position-relative d-flex align-items-center justify-content-center h-100">
                                    <img class="w-100 position-relative z-index-2 pt-4"
                                        src="<?php echo e(url('assets/img/illustrations/rocket-white.png')); ?>" alt="rocket">
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-lg-3">
            <div class="card h-100 p-3">
                <div class="overflow-hidden position-relative border-radius-lg bg-cover h-100">
                    <span class="mask bg-gradient-dark"><img src="<?php echo e(url(Auth::user()->image)); ?>" height="250"
                            width="250" class="sm me-3"></span>
        ...
        <div class="col-lg-12 mb-lg-0 mb-4">
            <div class="card z-index-2">
                <div class="card-body p-3">
                    ...
                    <h6 class="ms-2 mt-4 mb-0"> Monthly Progress </h6>
                    ...
                    <div class="container border-radius-lg">
                        <div class="row">
                            <div class="col-3 py-3 ps-0">
                                ...
                                <h4 class="font-weight-bolder"><?php echo e($totaltask_m ?? 'Na'); ?></h4>
                            ...
                            <div class="col-3 py-3 ps-0">
                                ...
                                <h4 class="font-weight-bolder"><?php echo e($complettask_m ?? 'Na'); ?></h4>
                                <div class="progress w-75">
                            ...
                            <div class="col-3 py-3 ps-0">
                                ...
                                <h4 class="font-weight-bolder"> <?php echo e($pendingtask_m ?? 'Na'); ?> </h4>
                                <div class="progress w-75">
                            ...
                            <div class="col-3 py-3 ps-0">
                                ...
                                <h4 class="font-weight-bolder"><?php echo e($proccesstask_m ?? 'Na'); ?></h4>
                                <div class="progress w-75">
...
<?php echo $__env->make('layouts.user_type.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\task_management\resources\views/dashboard.blade.php ENDPATH**/ ?>