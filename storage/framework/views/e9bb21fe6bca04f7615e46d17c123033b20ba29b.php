...
<form action="<?php echo e(url('daily-standup-checkin')); ?>" method="POST" role="form text-left" enctype="multipart/form-data" id="createdaccount">
  <?php echo csrf_field(); ?>
        <div class="firsttask">
            ...
            <div class="secondtask">
                ...
                <div class="innertask" style="<?php echo e(($task->deadline_date < date('Y-m-d')) ? 'background:#ffeced' : ''); ?>">
                    <div class="round">
                    <input type="checkbox" id="customCheck<?php echo e($task->id); ?>" name="selected_task_ids[]" value="<?php echo e($task->id); ?>">
                    <label class="custom-control-label" for="customCheck<?php echo e($task->id); ?>">
                    ...
                    <div class="paracard">
                        <p class="taskname">
                        (<?php echo e($task->task_code); ?>) <?php echo e($task->task_name); ?> 
                        </p>
                        <span>
...
<?php echo $__env->make('layouts.user_type.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\task_management\resources\views/daily_standup/checkin.blade.php ENDPATH**/ ?>