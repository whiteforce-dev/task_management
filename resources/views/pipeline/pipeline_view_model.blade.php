<div class="modal fade right" id="taskDetails-modal">
    ...
    justify-content: end; margin-left:-10px;">
                        ...
                        <div class="apply-btn" style="margin-top: -13px;margin-left: 12px;">
                            <button class="btn-one" id="applyBtn">View Image</button>
                        </div>
                    </div>
                </div>

                <div style="height: 463px; overflow-y: auto; overflow-x: hidden;padding-right: 15px; margin-top: 24px;"
                    id="response">
                ...
                <form class="newformto" id="myForm" style="position: sticky;bottom: 0;">@csrf
                    <div class="row">
    ...
    <div class="modalContainer">
        ...
        <div class="main-loader submitModal" style="z-index:2000">
            ...
            <div class="imgsec">
                ...
                <?php  $disk = Storage::disk('s3'); $img = $disk->temporaryUrl($taskImage, now()->addMinutes(5)); ?>                     
