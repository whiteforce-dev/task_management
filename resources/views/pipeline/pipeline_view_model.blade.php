<div class="modal fade right" id="taskDetails-modal">
    ...
    <style>
        ...
        *:after {
        ...
        .dropdown-contenttent table:hover {
    ...
    <div class="modal-dialog modal-lg"
        style="positon:relative; z-index: 2500;max-height: 100vh !important; min-height: 100vh;">
            ...
            <div class="modal-header text-white" style="background-color:#d70bbe; ">
                <h4 class="modal-title" style="color: white; font-size: 1.2rem !important; font-weight:500; ">
                    <span class="badge badge-primary"
                        style="background: #efeeee;color: #d70bbe;">{{ ucfirst($task->task_code) }}</span>
    ...
    height: 28px;
    padding-left: 4px;
    margin-right: 13px; padding-left: 3px !important;">Task
                            Details :
    ...
    justify-content: end; margin-left:-10px;">
                        ...
                        <div class="preecont btn">
                            <button class="dropbtn"
                                style="display: flex; align-items: center; justify-content: center; text-align: center;font-weight: 500 !important;">
                                View Details <i style="font-size: 1.2rem; margin-left: 5px; margin-top: -8px;"
                                    ...
                                    <tbody>
                                        <tr class="managern">
                                            ...
                                            <td style="margin-top:-4px; ">
                                                <p> {{ \Carbon\Carbon::parse($task->start_date)->format('d-m-Y') }}</p>
                                            </td>
                                            <td style="margin-top:-5px; ">
                                                <p> {{ \Carbon\Carbon::parse($task->deadline_date)->format('d-m-Y') }}
                                                </p>
                                            </td>
                                            <td style="margin-top:-3.5px; ">
                                ...
                                @if ($remark->userid !== Auth::user()->id)
                                    ...
                                    <div class="msg-bubble" style="margin-left:8px;">
                                        <div class="msg-info">
                                            ...
                                            <div class="msg-info-time">{{ $remark->created_at->format('M d, Y H:i:s') }}
                                            </div>
                                        </div>
                                        <div class="msg-text">
                                    ...
                                    <div class="msg-bubble">
                                        <div class="msg-info">
                                            ...
                                            <div class="msg-info-time">
                                                {{ $remark->created_at->format('M d, Y H:i:s') }}</div>
                                        </div>
                                        <div class="msg-text">
                                            <pre>{{ $remark->remark }}</pre>
                                        </div>
                    ...
                    <div class="row">
                        <div class="col-sm-10" style="margin-top:20px;">
                            <textarea name="manager_comments" cols="" rows="" class="form-control"
                                placeholder="Please enter comments..." style="width: 98%;
    margin-left: 14px; 
    position: relative;" required>
                        ...
                        <div class="col-sm-3" style="width: 32%; margin-top: 20px; display: flex; align-items: center;">
                            <select class="form-control select2" multiple data-live-search="true" name="notify_to[]"
                                id="notify_to" data-placement="top" style="width:100%;">
    ...
    max-height: 100vh;">
            <div class="upheaderbox">
                <div class="submit-btn">
                    <button class="sub-mit" id="form-cancel-menu">Back <i
                            class="fa-solid fa-share fa-flip-horizontal"
                            style="color: #d70bbe; margin-left: 5px;"></i> </button>
                ...
                @if (!empty($taskImages))
                    @foreach ($taskImages as $taskImage)
                        <div class="newpicshot">
                            <img src="{{ Storage::disk('s3')->temporaryUrl('task_management/task_attachments/' . $taskImage, now()->addMinutes(5)) }}"
                                alt="img">
                        </div>
                    @endforeach
                @endif
