    ...
    <div class="container-fluid py-4">
        ...
        <div class="card">
            ...
            <div class="card-body pt-4 p-3">
                <form action="{{ url('tag-store') }}" method="POST" role="form text-left" enctype="multipart/form-data" id="tagform">
                    @csrf
                    @if ($errors->any())
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('user.name')border border-danger rounded-3 @enderror">
                                    <input class="form-control" value="" type="text" placeholder=" Tag Name"
