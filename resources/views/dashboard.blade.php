...
@section('content')
    @php
        if (Auth::user()->type == 'admin') {
            ...
            $pendingtask = \App\Models\Taskmaster::where('software_catagory', Auth::user()->software_catagory)->where('status', '1')->count();
            $proccesstask = \App\Models\Taskmaster::where('software_catagory', Auth::user()->software_catagory)->where('status', '2')->count();
        
            $totaltask_m = \App\Models\Taskmaster::where('software_catagory', Auth::user()->software_catagory)->whereMonth('created_at', '=', date('m'))->count();
            $complettask_m = \App\Models\Taskmaster::where('software_catagory', Auth::user()->software_catagory)->whereMonth('created_at', '=', date('m'))
                ->where('status', '3')
                ->count();
            $pendingtask_m = \App\Models\Taskmaster::where('software_catagory', Auth::user()->software_catagory)->whereMonth('created_at', '=', date('m'))
                ->where('status', '1')
                ->count();
            ...
            <div class="card">
                <div class="card-body p-3">
                    <div class="row">
                        <div class="col-8">
                            <div class="numbers">
                                <a href="{{ url('dashbordcompletetask', Auth::user()->id) }}"> <p class="text-sm mb-0 text-capitalize font-weight-bold">Completed Task</p>
                                <h5 class="font-weight-bolder mb-0">
                                    {{ $complettask ?? 'Na' }}
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="d-flex flex-column h-100">
                                ...
                                <p class="mb-5">White force makes every one's life easy & every task magical. This task management solution keeps you updated in all your everyday tasks. Always be updated!!</p>
                        ...
                        <div class="col-lg-5 ms-auto text-center mt-5 mt-lg-0">
                            <div class="bg-gradient-primary border-radius-lg h-100">
                                <img src="{{ url('assets/img/shapes/waves-white.svg') }}"
                    ...
                    <div class="container border-radius-lg">
                        <div class="row">
                            ...
                            <div class="col-3 py-3 ps-0">
                                ...
                                <h4 class="font-weight-bolder">{{ $complettask_m ?? 'Na' }}</h4>
                                <div class="progress w-75">
                            ...
                            <div class="col-3 py-3 ps-0">
                                ...
                                <h4 class="font-weight-bolder"> {{ $pendingtask_m ?? 'Na' }} </h4>
                                <div class="progress w-75">
                            ...
                            <div class="col-3 py-3 ps-0">
                                ...
                                <h4 class="font-weight-bolder">{{ $proccesstask_m ?? 'Na' }}</h4>
                                <div class="progress w-75">
