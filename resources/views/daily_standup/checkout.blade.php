                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="user-name" class="form-control-label">What have you done today?</label><br>
                                ...
                                <div class="d-flex justify-content-center ">
                                    <button type="button" class="btn bg-gradient-dark btn-md mt-4 mb-4 col-md-4 proceed_btn" onclick="getDetailsDiv()">Proceed</button>
                                </div>
