...
<nav
    ...
    <div class="container-fluid {{ Request::is('static-sign-up') ? 'container' : 'container-fluid' }}">
        <a class="navbar-brand font-weight-bolder ms-lg-0 ms-3 {{ Request::is('static-sign-up') ? 'text-white' : '' }}"
            href="{{ url('dashboard') }}">
            <img src="{{ url('assets/img/white-force-logo.png') }}" height="40px;" />
        </a>
        ...
        <div class="collapse navbar-collapse" id="navigation">
            ...
            <ul class="navbar-nav d-lg-block d-none">
                <li class="nav-item">
                    <a href=""
                        class="btn btn-sm btn-round mb-0 me-1 bg-gradient-{{ Request::is('static-sign-up') ? 'light' : 'dark' }}"><i class='far fa-arrow' style='font-size:15px'>Go</i></a>
                </li>
            </ul>
        </div>
    </div>
