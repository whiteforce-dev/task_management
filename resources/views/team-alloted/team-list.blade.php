    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        <div class="container-fluid">
            ...
            <div class="row mt-4">
                <div class="col-12">
                    <div class="card">
                        <form action="{{ url('teamid-send',$tl_id) }}" method="POST" enctype="multipart/form-data">@csrf
                            ...
                            <tbody>
                                @foreach ($users as $i => $user)
                                    <tr>
                                        ...
                                        <td><input type="checkbox" name="teamIds[]" class="form-controll" value="{{ $user->id }}"></td>
                                    </tr>
                                @endforeach                                  
                            </tbody>
                        </table>  
